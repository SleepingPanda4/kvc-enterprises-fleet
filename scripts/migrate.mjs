...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS mgba_dsw_status_packages (
    id INTEGER PRIMARY KEY AUTOINCREMENT, route_row_id INTEGER NOT NULL REFERENCES mgba_dsw_route_rows(id) ON DELETE CASCADE,
    package_number INTEGER NOT NULL, additional_info TEXT, vision_label TEXT, tracking_id TEXT, destination_address TEXT,
    vehicle_number TEXT, vsa_status_code TEXT, star_status_code TEXT, star_scan_time TEXT, is_greyed_out INTEGER NOT NULL DEFAULT 0,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  "CREATE INDEX IF NOT EXISTS mgba_dsw_status_packages_route_row_idx ON mgba_dsw_status_packages (route_row_id)",
