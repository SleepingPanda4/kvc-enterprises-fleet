export type MonitorSortKey = "route" | "driver" | "vscan" | "delStops" | "puStops" | "diff" | "actDelStops" | "actDelPkgs" | "actPuStops" | "ilsPercent" | "statusCodes";
export type MonitorSort = { key: MonitorSortKey; direction: "asc" | "desc" };
export const MONITOR_SORT_KEYS: readonly MonitorSortKey[] = ["route", "driver", "vscan", "delStops", "puStops", "diff", "actDelStops", "actDelPkgs", "actPuStops", "ilsPercent", "statusCodes"];
